...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~351853e302eb468fda38e0de1efb4103:4c425876415356352f446f3d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Raju",
    BOT_NAME: process.env.BOT_NAME || 'Raju',
